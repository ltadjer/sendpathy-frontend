    ...
    <ion-content class="onboarding-content">
      ...
      >
        <swiper-slide class="slide slide-animated-logo">
          <img alt="Logo" :src="getLogo" width="80px" class="logo-animate" />
        </swiper-slide>
        <swiper-slide class="slide slide-welcome">
          ...
          <p>
            Un espace bienveillant pour partager et comprendre vos émotions, anonymement et en toute
            sécurité.
          </p>
        </swiper-slide>
        ...
        <swiper-slide class="slide slide-psy">
          ...
          <p>
            Besoin de parler à un professionnel ? Réservez facilement une séance en visio et prenez
            soin de vous.
          </p>
